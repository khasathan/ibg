...
def main():
    ...
    #_game = solver.letters_to_dec('game')
    #_of = solver.letters_to_dec('of')
    #_love = solver.letters_to_dec('love')
    ...
    answer_dec = int((((dota_ + is_ + ijlegcod_) / (a_ * (0) + b_)) * zanroo_) + tmfafj_)
